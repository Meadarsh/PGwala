  ...
  return (
    <div className=" lg:w-[20vw] bg-white rounded-lg shadow-md ">
      <div className="relative">
        ...
        />
        <Link to={"/contact"}>
          <div className=" absolute bottom-2 lg:right-2 left-2 lg:left-auto flex justify-center items-center lg:px-3 hover:bg-red-700 py-2  text-white text-lg bg-red-800 rounded-xl gap-4">
            <IoCall /> Contact
          </div>
        </Link>
      </div>
      <div className="p-4">
        <p className="text-xl font-semibold ">
          {data.singleSharingRent && <span> {data.singleSharingRent} ₹</span>}
        ...
        <div className="flex gap-2 mt-2">
          ...
          {data.tenantsPreferred && (
            <div className="flex gap-2 items-center border border-red-800 p-2 rounded-md">
              <div className="text-sm  leading-none">
          ...
          {data?.amenities?.kitchen && (
            <div className="flex gap-2 text-sm  leading-none py-1 font-semibold lg:text-md  items-center border border-red-800 p-2 rounded-md">
              Kitchen
            </div>
          )}
          {data?.amenities?.food && (
